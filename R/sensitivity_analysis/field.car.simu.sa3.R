...
i <- 0
field.car.simu.res.sd1.shape.1.39.scale.0.85 <- list()
n_realizations <- 100
while (i < n_realizations) {
  ...
  i = i + 1
  field.car.simu.res.sd1.shape.1.39.scale.0.85[[i]] <- field.car.simu.output
}
saveRDS(field.car.simu.res.sd1.shape.1.39.scale.0.85, file = (paste0(proj_root, "/data/gen/sensitivity_analysis/field.car.simu.res.sd1.shape.1.39.scale.0.85.rds")))
