...
while (i < n_realizations) {
  ...
  i = i + 1
  field.car.simu.res.sd1[[i]] <- field.car.simu.output
}
saveRDS(field.car.simu.res.sd1, file = (paste0(proj_root, "/data/gen/sensitivity_analysis/field.car.simu.res.sd1.rds")))
